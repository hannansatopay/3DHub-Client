<template>
    <div>
        ...
        <!-- <v-img height="290" position="center center" class="d-none d-sm-block" src="https://ik.imagekit.io/frlnc3rhub7/3dhub/website/Other_Page_Banners-02_AZCbsgGec.jpg"/>
        ...
        <v-container>
            ...
            <v-row>
                <v-col cols="12">
                    <h4 class="mb-5">Other Recommended Scanners</h4>
                    <client-only>
...
export default {
    ...
    computed: {
        ...
        randomProducts(){
            return _.shuffle(_.filter(_.reject(this.$store.getters.getProducts, {"name": this.$route.params.id}), {product_type: 'Scanners'}), 8)
        },
    }
}
