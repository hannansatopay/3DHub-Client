    ...
    <div>
        ...
        <v-container>
            ...
            <div class="my-5 my-sm-12">
                ...
                <p class="caption mb-0">Parts & Accessories</p>
...
export default {
    computed: {
        getPrinterProducts(){
            let products = this.$store.getters.getProducts.filter(a => a.part_type == this.$route.params.id &&  a.product_type == 'Parts & Accessories')
            return products
        },
    },
    components:{SearchToolBar, ProductTile},
    methods:{
        goBack(){
            window.history.back();
        },
